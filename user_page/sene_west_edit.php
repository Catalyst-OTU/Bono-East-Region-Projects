  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Edit SENE WEST Constituency Data</h4>
        </div>
        <div class="card-body">
        ...
        <?php
                ...
                if (isset($_POST['edit_btn']))
           {
                ...
                $query = "SELECT * FROM sene_west WHERE id='$id' ";
...
<a href="sene_west.php" class="btn btn-danger"> CANCEL </a>
<button type="submit" name="register_updatebtn_sene_west" class="btn btn-primary"> UPDATE </button>
