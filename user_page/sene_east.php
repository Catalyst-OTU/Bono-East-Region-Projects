...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h5><big>WELCOME TO SENE EAST CONSTITUENCY</big></h5>

    <form action="pdf_sene_east_constituency.php" method="POST">
            ...
            <form action="try.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="register_btn_sene_east" class="btn btn-primary">Save</button>
                </div>  
            </form>
        </div>
    </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <form action="try.php" method="POST">
                <button type="submit" name="delete_multiple_register_sene_east_data" class="btn btn-danger">Delete Multiple Data</button>
            </form>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">SENE EAST CONSTITUENCY DATATABLE</h6>
        </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="sene_east_edit.php" method="post">
                        ...
                        <td>
                            ...
                            <form action="try.php" method="post">
                                ...
                                <button type="submit" name="delete_btn_sene_east" class="btn btn-danger">DELETE</button>
                            </form>
                        </td>
