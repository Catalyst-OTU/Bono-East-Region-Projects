  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Edit TECHIMAN NORTH Constituency Data</h4>
        </div>
        <div class="card-body">
        ...
        <?php
                ...
                if (isset($_POST['edit_btn']))
           {
                ...
                $query = "SELECT * FROM techiman_north WHERE id='$id' ";
...
<a href="techiman_north.php" class="btn btn-danger"> CANCEL </a>
<button type="submit" name="register_updatebtn_techiman_north" class="btn btn-primary"> UPDATE </button>
