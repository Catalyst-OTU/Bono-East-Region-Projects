  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">EDIT ATEBUBU / AMANTIN CONSTITUENCY NDC MEMBER PROFILE</h6>
        </div>
        <div class="card-body">
        ...
        <?php
                ...
                if (isset($_POST['edit_btn']))
           {
                ...
                $query = "SELECT * FROM ndc WHERE id='$id' ";
...
<a href="atebubu_amantin_ndc.php" class="btn btn-danger"> CANCEL </a>
<button type="submit" name="update_atebubu/amantin_ndc_btn" class="btn btn-primary"> UPDATE </button>
