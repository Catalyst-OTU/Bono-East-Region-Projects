...
<div class="form-group">
    <label>Constituency</label>
                  <select name="constituencies" value="<?php echo $row['constituencies'] ?>" class="form-control">
...
<button type="submit" name="register_admin_updatebtn" class="btn btn-primary"> UPDATE </button>
