...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><big>ALL PARTY MEMBERS DASHBOARD</big></h1>
 ...
 <div class="modal-dialog" role="document">
     <div class="modal-content">
         <div class="modal-header">
            ...
            <form action="code.php" method="POST" action="voters" method="POST" enctype="multipart/form-data">
...
<div class="form-group">
    <label>Party</label>
      <select name="select_party" class="form-control" required>
  ...
  <button type="submit" name="register_btn" class="btn btn-primary">Save</button>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Member Profile

            <form action="code.php" method="POST">
                    <button type="submit" name="delete_multiple_register_data" class="btn btn-danger">Delete Multiple Data</button>
                </form>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">ALL MEMBERS MEMBERS DATATABLE</h6>
            </div>
            <div class="card-body">
...
?>
    ...
    <tr>
                        ...
                        <td><?php echo $row['select_party']; ?></td>
