...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h5>ATEBUBU / AMANTIN CONSTITUENCY OTHER MEMBERS PROFILE</h5>

    <form action="pdf_atebubu_amantin_others.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    ...
    <label>Polling Stations</label>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="register_btn_atebubu_amantin_others" class="btn btn-primary">Save</button>
                </div>  
            </form>
        </div>
    </div>
...
<br><br><br>
    ...
    <div class="chart">
    <h4><a href="atebubu_amantin.php">ATEBUBU / AMANTIN CONSTITUENCY</a></h4>
               <br>
               <ul class="numbers">
            <li><span>100%</span></li>
            <li><span>50%</span></li>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><h4>AGE DATATABLE</h4></div>
                      <br><br>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
...
<br><br><br><br><br><br><br><br>
    ...
    <div class="card-header py-3">
        ...
        <form action="u_code.php" method="POST">
                <button type="submit" name="delete_multiple_atebubu/amantin_others_data" class="btn btn-danger">Delete Multiple Data</button>
            </form>


            <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addadminprofile">
                Add Others Member Profile
            </button>
        </h6>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">BONO REGION OTHER MEMBERS DATATABLE</h6>
        </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="atebubu_amantin_others_edit.php" method="post">
                        ...
                        <td>
                            ...
                            <form action="u_code.php" method="post">
                                ...
                                <button type="submit" name="delete_atebubu/amantin_others_btn" class="btn btn-danger">DELETE</button>
                            </form>
                        </td>
