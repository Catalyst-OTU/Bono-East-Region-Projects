...
<li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="u_kintampo_north_constituency.php">Kintampo North</a>:</h6>
...
<li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="u_kintampo_south_constituency.php">Kintampo South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="u_nkoranza_north_constituency.php">Nkoranza North</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="u_nkoranza_south_constituency.php">Nkoranza South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="u_pru_east_constituency.php">Pru East</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="pru_west_constituency.php">Pru West</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="sene_east_constituency.php">Sene East</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="sene_west_constituency.php">Sene West</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="techiman_north_constituency.php">Techiman North</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
...
<li class="nav-item">
        ...
        <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><a href="techiman_south_constituency.php">Techiman South</a>:</h6>
            <a class="collapse-item" href="#">NPP</a>
            <a class="collapse-item" href="#">NDC</a>
            <a class="collapse-item" href="#">OTHERS</a>
          </div>
