...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h5>ATEBUBU / AMANTIN CONSTITUENCY NPP MEMBERS PROFILE</h5>

    <form action="pdf_atebubu_amantin_npp.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
         <div class="modal-header">
             <h5 class="modal-title" id="exampleModalLabel">Add NPP Member Data</h5>
    ...
    <label>Polling Stations</label>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="register_btn_atebubu_amantin_npp" class="btn btn-primary">Save</button>
                </div>  
            </form>
        </div>
    </div>
...
<br><br><br><br>
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">NPP Members Profile

        <form action="u_code.php" method="POST">
                <button type="submit" name="delete_multiple_atebubu/amantin_npp_data" class="btn btn-danger">Delete Multiple Data</button>
            </form>


            <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addadminprofile">
                Add NPP Member Profile
            </button>
        </h6>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">BONO REGION NPP MEMBERS DATATABLE</h6>
        </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="atebubu_amantin_npp_edit.php" method="post">
                        ...
                        <td>
                            ...
                            <form action="u_code.php" method="post">
                                ...
                                <button type="submit" name="delete_atebubu/amantin_npp_btn" class="btn btn-danger">DELETE</button>
                            </form>
                        </td>
