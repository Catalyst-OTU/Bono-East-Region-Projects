  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">EDIT ATEBUBU / AMANTIN CONSTITUENCY OTHER MEMBER PROFILE</h6>
        </div>
        <div class="card-body">
...
<a href="atebubu_amantin_others.php" class="btn btn-danger"> CANCEL </a>
<button type="submit" name="update_atebubu/amantin_others_btn" class="btn btn-primary"> UPDATE </button>
