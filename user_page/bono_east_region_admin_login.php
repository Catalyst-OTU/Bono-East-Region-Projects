          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Bono East Region Npp Admin Login!</h1>
            ...
            <div class="form-group">
                ...
                <button type="submit" name="bono_east_region_login_btn" class="btn btn-primary btn-user btn-block">Login</button>
                <hr>
                <p class="text-center">Back to Regions? <a href="regions.php">Logout</a></p>
            </form>
